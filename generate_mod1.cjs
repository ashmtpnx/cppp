  ...
  subtopics: [
    {
      ...
      diagram: {
        viewBox: "0 0 700 200",
        controls: [
          { id: "all", label: "Full Compilation Flow", highlightNodes: ["src", "prep", "comp", "obj", "link", "exe"], highlightEdges: ["e1", "e2", "e3", "e4"] },
          { id: "prep_stage", label: "1. Preprocessor", highlightNodes: ["src", "prep"], highlightEdges: ["e1"] },
          { id: "comp_stage", label: "2. Compiler", highlightNodes: ["prep", "comp", "obj"], highlightEdges: ["e2", "e3"] },
          { id: "link_stage", label: "3. Linker", highlightNodes: ["obj", "link", "exe"], highlightEdges: ["e4"] }
        ],
        nodes: [
          { id: "src", label: "Source (.cpp)", x: 70, y: 100 },
          { id: "prep", label: "Preprocessor", x: 200, y: 100 },
          { id: "comp", label: "Compiler", x: 330, y: 100 },
          { id: "obj", label: "Object (.o)", x: 460, y: 100 },
          { id: "link", label: "Linker", x: 560, y: 100 },
          { id: "exe", label: "Binary (.exe)", x: 660, y: 100 }
        ],
        edges: [
          { id: "e1", from: "src", to: "prep" },
          { id: "e2", from: "prep", to: "comp" },
          { id: "e3", from: "comp", to: "obj" },
          { id: "e4", from: "obj", to: "link" }
        ]
      }
    },
    {
      ...
      diagram: {
        viewBox: "0 0 600 250",
        controls: [
          { id: "all", label: "Timeline", highlightNodes: ["c", "cpp98", "cpp11", "cpp17"], highlightEdges: ["e1", "e2", "e3"] },
          { id: "cpp11", label: "C++11 (Modern C++)", highlightNodes: ["cpp11"], highlightEdges: [] },
          { id: "cpp17", label: "C++17 (Structured Bindings)", highlightNodes: ["cpp17"], highlightEdges: [] }
        ],
        nodes: [
          { id: "c", label: "1979: C w/ Classes", x: 100, y: 125 },
          { id: "cpp98", label: "1998: C++98", x: 250, y: 125 },
          { id: "cpp11", label: "2011: C++11", x: 400, y: 125 },
          { id: "cpp17", label: "2017: C++17", x: 550, y: 125 }
        ],
        edges: [
          { id: "e1", from: "c", to: "cpp98" },
          { id: "e2", from: "cpp98", to: "cpp11" },
          { id: "e3", from: "cpp11", to: "cpp17" }
        ]
      }
    },
    {
...
Python     | ~2.50 seconds   | ~15 MB          | 5% (Often TLEs)</code></pre>
      ...
      diagram: {
        viewBox: "0 0 500 300",
        controls: [
          { id: "all", label: "Speed Comparison", highlightNodes: ["cpp", "java", "py"], highlightEdges: [] },
          { id: "cpp", label: "C++ (Fastest)", highlightNodes: ["cpp"], highlightEdges: [] }
        ],
        nodes: [
          { id: "cpp", label: "C++: ~0.05s", x: 250, y: 250 },
          { id: "java", label: "Java: ~0.40s", x: 250, y: 150 },
          { id: "py", label: "Python: ~2.50s", x: 250, y: 50 }
        ],
        edges: []
      }
    },
...
Examples            | C, Pascal, Fortran              | C++, Java, Python, C#</code></pre>
      ...
      diagram: {
        viewBox: "0 0 600 300",
        controls: [
          { id: "all", label: "Compare Architectures", highlightNodes: ["pop", "oop"], highlightEdges: [] },
          { id: "pop", label: "Procedural (Action focused)", highlightNodes: ["pop"], highlightEdges: [] },
          { id: "oop", label: "OOP (Data focused)", highlightNodes: ["oop"], highlightEdges: [] }
        ],
        nodes: [
          { id: "pop", label: "POP: Global() -> Data", x: 170, y: 150 },
          { id: "oop", label: "OOP: Object{ Data, Methods() }", x: 450, y: 150 }
        ],
        edges: []
      }
    },
    {
      ...
      diagram: {
        viewBox: "0 0 500 400",
        controls: [
          { id: "all", label: "The 4 Pillars", highlightNodes: ["oop", "encap", "abs", "inh", "poly"], highlightEdges: ["e1", "e2", "e3", "e4"] },
          { id: "encap", label: "1. Encapsulation", highlightNodes: ["oop", "encap"], highlightEdges: ["e1"] },
          { id: "abs", label: "2. Abstraction", highlightNodes: ["oop", "abs"], highlightEdges: ["e2"] },
          { id: "inh", label: "3. Inheritance", highlightNodes: ["oop", "inh"], highlightEdges: ["e3"] },
          { id: "poly", label: "4. Polymorphism", highlightNodes: ["oop", "poly"], highlightEdges: ["e4"] }
        ],
        nodes: [
          { id: "oop", label: "OOP", x: 250, y: 200 },
          { id: "encap", label: "Encapsulation", x: 250, y: 50 },
          { id: "abs", label: "Abstraction", x: 400, y: 200 },
          { id: "inh", label: "Inheritance", x: 250, y: 350 },
          { id: "poly", label: "Polymorphism", x: 100, y: 200 }
        ],
        edges: [
          { id: "e1", from: "oop", to: "encap" },
          { id: "e2", from: "oop", to: "abs" },
          { id: "e3", from: "oop", to: "inh" },
          { id: "e4", from: "oop", to: "poly" }
        ]
      }
    },
    {
      ...
      diagram: {
        viewBox: "0 0 500 300",
        controls: [
          { id: "all", label: "Stream Hierarchy", highlightNodes: ["ios", "istream", "ostream", "cin", "cout", "cerr"], highlightEdges: ["e1", "e2", "e3", "e4", "e5"] }
        ],
        nodes: [
          { id: "ios", label: "ios (Base)", x: 250, y: 50 },
          { id: "istream", label: "istream", x: 120, y: 150 },
          { id: "ostream", label: "ostream", x: 380, y: 150 },
          { id: "cin", label: "cin", x: 120, y: 250 },
          { id: "cout", label: "cout (Buffered)", x: 300, y: 250 },
          { id: "cerr", label: "cerr (Unbuffered)", x: 460, y: 250 }
        ],
        edges: [
          { id: "e1", from: "ios", to: "istream" },
          { id: "e2", from: "ios", to: "ostream" },
          { id: "e3", from: "istream", to: "cin" },
          { id: "e4", from: "ostream", to: "cout" },
          { id: "e5", from: "ostream", to: "cerr" }
        ]
      }
    },
    {
...
int main() {
    ...
    return 0;
      ...
      diagram: {
        viewBox: "0 0 600 200",
        controls: [
          { id: "all", label: "Data Flow Pipeline", highlightNodes: ["kb", "cin", "var", "cout", "scr"], highlightEdges: ["e1", "e2", "e3", "e4"] },
          { id: "input_flow", label: "Input Extraction (>>)", highlightNodes: ["kb", "cin", "var"], highlightEdges: ["e1", "e2"] },
          { id: "output_flow", label: "Output Insertion (<<)", highlightNodes: ["var", "cout", "scr"], highlightEdges: ["e3", "e4"] }
        ],
        nodes: [
          { id: "kb", label: "Keyboard", x: 70, y: 100 },
          { id: "cin", label: "cin >>", x: 180, y: 100 },
          { id: "var", label: "Variables (RAM)", x: 300, y: 100 },
          { id: "cout", label: "cout <<", x: 420, y: 100 },
          { id: "scr", label: "Monitor", x: 530, y: 100 }
        ],
        edges: [
          { id: "e1", from: "kb", to: "cin" },
          { id: "e2", from: "cin", to: "var" },
          { id: "e3", from: "var", to: "cout" },
          { id: "e4", from: "cout", to: "scr" }
        ]
      }
    },
    {
...
int main() {
    ...
    return 0;
      ...
      diagram: {
        viewBox: "0 0 500 200",
        controls: [
          { id: "all", label: "Clearing Process", highlightNodes: ["pre", "sys", "post"], highlightEdges: ["e1", "e2"] }
        ],
        nodes: [
          { id: "pre", label: "Messy Terminal", x: 100, y: 100 },
          { id: "sys", label: "system('cls')", x: 250, y: 100 },
          { id: "post", label: "Clean UI", x: 400, y: 100 }
        ],
        edges: [
          { id: "e1", from: "pre", to: "sys" },
          { id: "e2", from: "sys", to: "post" }
        ]
      }
    },
    {
...
int return = 5;          // INVALID (return is a keyword)</code></pre>
      ...
      diagram: {
        viewBox: "0 0 500 250",
        controls: [
          { id: "all", label: "Identifier Validation", highlightNodes: ["id", "val", "val2", "inval1", "inval2"], highlightEdges: ["e1", "e2", "e3", "e4"] },
          { id: "valid", label: "Valid Identifiers", highlightNodes: ["id", "val", "val2"], highlightEdges: ["e1", "e2"] },
          { id: "invalid", label: "Invalid Identifiers", highlightNodes: ["id", "inval1", "inval2"], highlightEdges: ["e3", "e4"] }
        ],
        nodes: [
          { id: "id", label: "Is Valid Identifier?", x: 150, y: 125 },
          { id: "val", label: "_speed (Yes)", x: 380, y: 40 },
          { id: "val2", label: "player1 (Yes)", x: 380, y: 100 },
          { id: "inval1", label: "1player (No)", x: 380, y: 160 },
          { id: "inval2", label: "int (No)", x: 380, y: 220 }
        ],
        edges: [
          { id: "e1", from: "id", to: "val" },
          { id: "e2", from: "id", to: "val2" },
          { id: "e3", from: "id", to: "inval1" },
          { id: "e4", from: "id", to: "inval2" }
        ]
      }
    },
    {
...
cout &lt;&lt; "She screamed, \\"Watch out!\\"";</code></pre>
      ...
      diagram: {
        viewBox: "0 0 500 250",
        controls: [
          { id: "all", label: "Escape Character Mapping", highlightNodes: ["esc", "nl", "tab", "quote"], highlightEdges: ["e1", "e2", "e3"] }
        ],
        nodes: [
          { id: "esc", label: "Escape Token: \\", x: 120, y: 125 },
          { id: "nl", label: "n -> [Line Break]", x: 380, y: 50 },
          { id: "tab", label: "t -> [Tab Space]", x: 380, y: 125 },
          { id: "quote", label: "\" -> [Print Quote]", x: 380, y: 200 }
        ],
        edges: [
          { id: "e1", from: "esc", to: "nl" },
          { id: "e2", from: "esc", to: "tab" },
          { id: "e3", from: "esc", to: "quote" }
        ]
      }
    },
    {
...
sort(arr.begin(), arr.end());</code></pre>
      ...
      diagram: {
        viewBox: "0 0 500 200",
        controls: [
          { id: "all", label: "Compiler Flow", highlightNodes: ["code", "comp", "ignore", "exec"], highlightEdges: ["e1", "e2", "e3"] }
        ],
        nodes: [
          { id: "code", label: "Source Code + //", x: 100, y: 100 },
          { id: "comp", label: "Preprocessor", x: 260, y: 100 },
          { id: "ignore", label: "Ignores // Text", x: 260, y: 30 },
          { id: "exec", label: "Clean Code", x: 420, y: 100 }
        ],
        edges: [
          { id: "e1", from: "code", to: "comp" },
          { id: "e2", from: "comp", to: "ignore" },
          { id: "e3", from: "comp", to: "exec" }
        ]
      }
    }
  ]
...
const fileContent = 'export const module1Data = ' + JSON.stringify(mod1, null, 2) + ';';
fs.writeFileSync('src/data/module_1.js', fileContent);
console.log("Successfully created highly detailed src/data/module_1.js");
